...
def graph_to_clause(V, E, k):
    """V is the set of vertex (list of index), E is the set of edges (list for couples)
    k is the number of colors"""
    n_var_raw = len(V)
    Vars = [[1+k*i+j for j in range(k)] for i in range(n_var_raw)]
    sat_3_pb = []
    for i in range(n_var_raw):
        sat_3_pb.append(Vars[i])
    for v in range(n_var_raw):
        for i in range(k):
            for j in range(i+1, k):
                sat_3_pb.append([-Vars[v][i], -Vars[v][j]])
    for edge in E:
        for i in range(k):
            sat_3_pb.append([-Vars[edge[0]][i], -Vars[edge[1]][i]])
    return sat_3_pb
...
def sat_to_3sat(Sat, nbr_var):
    ...
    for clause in Sat:
        if len(clause) == 2:
            var_sup += 1
            Sat.append(clause+[-(nbr_var+var_sup)])
            clause.append(nbr_var+var_sup)
    print(Sat)

# BackendProperties(backend_name='ibmqx4', backend_version='1.0.0', gates=[Gate(gate='u1', parameters=[Nduv(date=datetime.datetime(2019, 6, 27, 9, 56, 57, tzinfo=tzutc()), name='gate_error', unit='', value=0.0)], qubits=[0]), Gate(gate='u2', parameters=[Nduv(date=datetime.datetime(2019, 6, 27, 9, 56, 57, tzinfo=tzutc()), name='gate_error', unit='', value=0.00128782749692391)], qubits=[0]), Gate(gate='u3', parameters=[Nduv(date=datetime.datetime(2019, 6, 27, 9, 56, 57, tzinfo=tzutc()), name='gate_error', unit='', value=0.00257565499384782)], qubits=[0]), Gate(gate='u1', parameters=[Nduv(date=datetime.datetime(2019, 6, 27, 9, 56, 57, tzinfo=tzutc()), name='gate_error', unit='', value=0.0)], qubits=[1]), Gate(gate='u2', parameters=[Nduv(date=datetime.datetime(2019, 6, 27, 9, 56, 57, tzinfo=tzutc()), name='gate_error', unit='', value=0.001889001411209068)], qubits=[1]), Gate(gate='u3', parameters=[Nduv(date=datetime.datetime(2019, 6, 27, 9, 56, 57, tzinfo=tzutc()), name='gate_error', unit='', value=0.003778002822418136)], qubits=[1]), Gate(gate='u1', parameters=[Nduv(date=datetime.datetime(2019, 6, 27, 9, 56, 57, tzinfo=tzutc()), name='gate_error', unit='', value=0.0)], qubits=[2]), Gate(gate='u2', parameters=[Nduv(date=datetime.datetime(2019, 6, 27, 9, 56, 57, tzinfo=tzutc()), name='gate_error', unit='', value=0.0013737021608475342)], qubits=[2]), Gate(gate='u3', parameters=[Nduv(date=datetime.datetime(2019, 6, 27, 9, 56, 57, tzinfo=tzutc()), name='gate_error', unit='', value=0.0027474043216950683)], qubits=[2]), Gate(gate='u1', parameters=[Nduv(date=datetime.datetime(2019, 6, 27, 9, 56, 57, tzinfo=tzutc()), name='gate_error', unit='', value=0.0)], qubits=[3]), Gate(gate='u2', parameters=[Nduv(date=datetime.datetime(2019, 6, 27, 9, 56, 57, tzinfo=tzutc()), name='gate_error', unit='', value=0.001545458810288558)], qubits=[3]), Gate(gate='u3', parameters=[Nduv(date=datetime.datetime(2019, 6, 27, 9, 56, 57, tzinfo=tzutc()), name='gate_error', unit='', value=0.003090917620577116)], qubits=[3]), Gate(gate='u1', parameters=[Nduv(date=datetime.datetime(2019, 6, 27, 9, 56, 57, tzinfo=tzutc()), name='gate_error', unit='', value=0.0)], qubits=[4]), Gate(gate='u2', parameters=[Nduv(date=datetime.datetime(2019, 6, 27, 9, 56, 57, tzinfo=tzutc()), name='gate_error', unit='', value=0.00128782749692391)], qubits=[4]), Gate(gate='u3', parameters=[Nduv(date=datetime.datetime(2019, 6, 27, 9, 56, 57, tzinfo=tzutc()), name='gate_error', unit='', value=0.00257565499384782)], qubits=[4]), Gate(gate='cx', name='CX1_0', parameters=[Nduv(date=datetime.datetime(2019, 6, 27, 9, 26, 28, tzinfo=tzutc()), name='gate_error', unit='', value=0.036672568695508584)], qubits=[1, 0]), Gate(gate='cx', name='CX2_0', parameters=[Nduv(date=datetime.datetime(2019, 6, 27, 9, 32, 2, tzinfo=tzutc()), name='gate_error', unit='', value=0.025673203929814814)], qubits=[2, 0]), Gate(gate='cx', name='CX2_1', parameters=[Nduv(date=datetime.datetime(2019, 6, 27, 9, 37, 27, tzinfo=tzutc()), name='gate_error', unit='', value=0.06008495767103711)], qubits=[2, 1]), Gate(gate='cx', name='CX3_2', parameters=[Nduv(date=datetime.datetime(2019, 6, 27, 9, 43, 1, tzinfo=tzutc()), name='gate_error', unit='', value=0.07599213104899905)], qubits=[3, 2]), Gate(gate='cx', name='CX3_4', parameters=[Nduv(date=datetime.datetime(2019, 6, 27, 9, 48, 37, tzinfo=tzutc()), name='gate_error', unit='', value=0.042775579309329986)], qubits=[3, 4]), Gate(gate='cx', name='CX4_2', parameters=[Nduv(date=datetime.datetime(2019, 6, 27, 9, 53, 53, tzinfo=tzutc()), name='gate_error', unit='', value=0.049168289409378535)], qubits=[4, 2])], general=[], last_update_date=datetime.datetime(2019, 6, 27, 9, 53, 53, tzinfo=tzutc()), qconsole=False, qubits=[[Nduv(date=datetime.datetime(2019, 6, 27, 9, 16, 38, tzinfo=tzutc()), name='T1', unit='µs', value=42.51964597288964), Nduv(date=datetime.datetime(2019, 6, 27, 9, 17, 22, tzinfo=tzutc()), name='T2', unit='µs', value=18.4246512893064), Nduv(date=datetime.datetime(2019, 6, 27, 9, 53, 53, tzinfo=tzutc()), name='frequency', unit='GHz', value=5.24633338627017), Nduv(date=datetime.datetime(2019, 6, 27, 9, 16, 20, tzinfo=tzutc()), name='readout_error', unit='', value=0.04749999999999999)], [Nduv(date=datetime.datetime(2019, 6, 27, 1, 18, 28, tzinfo=tzutc()), name='T1', unit='µs', value=44.270424902786154), Nduv(date=datetime.datetime(2019, 6, 27, 9, 18, 6, tzinfo=tzutc()), name='T2', unit='µs', value=10.014807266084954), Nduv(date=datetime.datetime(2019, 6, 27, 9, 53, 53, tzinfo=tzutc()), name='frequency', unit='GHz', value=5.29830231872285), Nduv(date=datetime.datetime(2019, 6, 27, 9, 16, 20, tzinfo=tzutc()), name='readout_error', unit='', value=0.06299999999999994)], [Nduv(date=datetime.datetime(2019, 6, 27, 9, 16, 38, tzinfo=tzutc()), name='T1', unit='µs', value=45.11799066618261), Nduv(date=datetime.datetime(2019, 6, 27, 9, 18, 47, tzinfo=tzutc()), name='T2', unit='µs', value=52.5801697586212), Nduv(date=datetime.datetime(2019, 6, 27, 9, 53, 53, tzinfo=tzutc()), name='frequency', unit='GHz', value=5.338326989174132), Nduv(date=datetime.datetime(2019, 6, 27, 9, 16, 20, tzinfo=tzutc()), name='readout_error', unit='', value=0.20575)], [Nduv(date=datetime.datetime(2019, 6, 26, 9, 14, 52, tzinfo=tzutc()), name='T1', unit='µs', value=42.249356420641234), Nduv(date=datetime.datetime(2019, 6, 27, 9, 18, 6, tzinfo=tzutc()), name='T2', unit='µs', value=27.5676670930478), Nduv(date=datetime.datetime(2019, 6, 27, 9, 53, 53, tzinfo=tzutc()), name='frequency', unit='GHz', value=5.426123814370482), Nduv(date=datetime.datetime(2019, 6, 27, 9, 16, 20, tzinfo=tzutc()), name='readout_error', unit='', value=0.35150000000000003)], [Nduv(date=datetime.datetime(2019, 6, 27, 9, 16, 38, tzinfo=tzutc()), name='T1', unit='µs', value=52.621381150281906), Nduv(date=datetime.datetime(2019, 6, 27, 9, 17, 22, tzinfo=tzutc()), name='T2', unit='µs', value=6.378411387753913), Nduv(date=datetime.datetime(2019, 6, 27, 9, 53, 53, tzinfo=tzutc()), name='frequency', unit='GHz', value=5.174575063790818), Nduv(date=datetime.datetime(2019, 6, 27, 9, 16, 20, tzinfo=tzutc()), name='readout_error', unit='', value=0.24649999999999994)]])